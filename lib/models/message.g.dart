...
const MessageSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'lastTime': IndexSchema(
      id: -5102247151867938967,
      name: r'lastTime',
      unique: false,
      replace: false,
      properties: [
...
int _messageEstimateSize(
  ...
  bytesCount += 3 + object.lastTime.length * 3;
...
extension MessageQueryWhere on QueryBuilder<Message, Message, QWhereClause> {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> lastTimeEqualTo(
      String lastTime) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'lastTime',
        value: [lastTime],
      ));
    });
  }

  QueryBuilder<Message, Message, QAfterWhereClause> lastTimeNotEqualTo(
      String lastTime) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension MessageQueryFilter
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastTime',
        value: '',
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> lastTimeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'lastTime',
        value: '',
...
extension MessageQuerySortBy on QueryBuilder<Message, Message, QSortBy> {
  ...
  QueryBuilder<Message, Message, QAfterSortBy> sortByLastTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastTime', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByLastTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQuerySortThenBy
  ...
  QueryBuilder<Message, Message, QAfterSortBy> thenByLastTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastTime', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByLastTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastTime', Sort.desc);
    });
  }
...
extension MessageQueryWhereDistinct
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByLastTime(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, String, QQueryOperations> lastTimeProperty() {
    return QueryBuilder.apply(this, (query) {
